...
const EarnPage = () => {
  ...
  return (
    <div className="pb-32">
      <EarnHero
        mainTitle="BIDMore Earning Vaults"
        subTitle="Deposit crypto or cash to automatically earn 30% of all of the revenue generated by the BidMore platform."
        secondTitle="New to BidMore Earning Vaults?"
        secondSubTitle="Learn about what BidMore earnings vaults are, what the benefits are and how to get started."
        docLink="#"
      />
      <EarnSection />
      <RewardSection
