...
export interface ChartingLibraryWidgetOptions {
   ...
   *
   * Note that favorites saved in [`localStorage`](https://developer.mozilla.org/en-US/docs/Web`${baseUrl}api/Window/localStorage) take precedence over the ones specified in the `favorites` property.
...
export interface IChartingLibraryWidget {
   ...
   * If you don't know the key code you need you can use resources like [keycode.info](https://keycode.info), or [MDN](https://developer.mozilla.org/en-US/docs/Web`${baseUrl}api/KeyboardEvent/keyCode) to check.
